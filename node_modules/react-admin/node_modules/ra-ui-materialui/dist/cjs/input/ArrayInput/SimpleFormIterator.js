...
var SimpleFormIterator = function (props) {
    ...
    var _j = (0, react_hook_form_1.useFormContext)(), resetField = _j.resetField, trigger = _j.trigger, getValues = _j.getValues;
    ...
    var removeField = (0, react_1.useCallback)(function (index) {
        remove(index);
        var isScalarArray = getValues(source).every(function (value) { return typeof value !== 'object'; });
        if (isScalarArray) {
    ...
    if (fields.length > 0) {
        var _k = fields[0], id = _k.id, rest = __rest(_k, ["id"]);
