...
var ListView = function (props) {
    ...
    var _e = (0, ra_core_1.useListContext)(props), defaultTitle = _e.defaultTitle, data = _e.data, error = _e.error, isLoading = _e.isLoading, filterValues = _e.filterValues, resource = _e.resource;
    ...
    var renderList = function () { return (React.createElement("div", { className: exports.ListClasses.main },
        (filters || actions) && (React.createElement(ListToolbar_1.ListToolbar, { className: exports.ListClasses.actions, filters: filters, actions: actions, hasCreate: hasCreate })),
        React.createElement(Content, { className: exports.ListClasses.content }, bulkActionButtons &&
            ...
            : children),
        error ? (React.createElement(layout_1.Error, { error: error, resetErrorBoundary: function () { } })) : (pagination !== false && pagination))); };
    var renderEmpty = function () {
        return empty !== false &&
            (0, react_1.cloneElement)(empty, { className: exports.ListClasses.noResults, hasCreate: hasCreate });
    };
