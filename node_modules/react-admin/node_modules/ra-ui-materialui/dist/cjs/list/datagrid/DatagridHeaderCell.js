...
var DatagridHeaderCell = function (props) {
    ...
    return (React.createElement(StyledTableCell, __assign({ className: (0, clsx_1.default)(className, field.props.headerClassName), align: field.props.textAlign || field.type.textAlign, variant: "head" }, rest), updateSort &&
