import { FilterPayload, GetListResult, RaRecord, SortPayload } from '../../types';
...
export interface UseReferenceArrayInputParams<RecordType extends RaRecord = any> {
    ...
    queryOptions?: UseQueryOptions<GetListResult<RecordType> | GetManyAggregateResult<RecordType>> & {
        meta?: any;
    };
    page?: number;
    perPage?: number;
