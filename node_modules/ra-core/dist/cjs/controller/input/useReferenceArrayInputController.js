...
var useReferenceArrayInputController = function (props) {
    ...
    var _f = (0, dataProvider_1.useGetManyAggregate)(reference, {
        ...
        meta: meta,
    }, __assign({ enabled: value != null && value.length > 0 }, otherQueryOptions)), referenceRecords = _f.data, errorGetMany = _f.error, isLoadingGetMany = _f.isLoading, isFetchingGetMany = _f.isFetching, refetchGetMany = _f.refetch;
